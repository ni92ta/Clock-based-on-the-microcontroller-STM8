...
//Настройка портов
	...
	GPIOD->DDR |= (1<<7) | (1<<6) | (1<<5) | (1<<4) | (1<<3) | (1<<2) | (1<<1) | (1<<0);//Выход
	GPIOD->CR1 |= (1<<7) | (1<<6) | (1<<5) | (1<<4) | (1<<3) | (1<<2) | (1<<1) | (1<<0);//Выход типа Push-pull
	GPIOD->CR2 |= (1<<7) | (1<<6) | (1<<5) | (1<<4) | (1<<3) | (1<<2) | (1<<1) | (1<<0);//Скорость переключения - до 10 МГц.
